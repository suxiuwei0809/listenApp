...
import com.example.fitforge.ui.screen.*
import com.example.fitforge.ui.theme.BackgroundDeep
        ...
        NavHost(
            ...
            composable(Screen.Home.route) {
                HomeScreen(
                    ...
                    onNavigateToGymExec = { target ->
                        navController.navigate(Screen.GymExec.createRoute(target))
                    }
                )
            }
            ...
            composable(Screen.GymExec.route) { backStackEntry ->
                val target = backStackEntry.arguments?.getString("target") ?: "back"
                GymExecScreen(
                    target = target,
